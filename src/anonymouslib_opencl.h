        ...
        cl_device_id *  ocl_device)
{
    ...
    const char* _ocl_source_code_string_format_const_tmp[] = {
    ...
    for (const char* elem: _ocl_source_code_string_format_const_tmp) {
        _ocl_source_code_string_format_const += elem;
    }

    const char* _ocl_source_code_string_csr5_spmv_const_tmp[] = {
        "    //#pragma OPENCL EXTENSION cl_khr_global_int32_base_atomics : enable                               \n",
    ...
    for (const char* elem: _ocl_source_code_string_csr5_spmv_const_tmp) {
        _ocl_source_code_string_csr5_spmv_const += elem;
    }
