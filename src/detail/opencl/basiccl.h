...
public:
    ...
    int getDeviceInfo(cl_device_id device, char* deviceName, char* deviceVersion, int* deviceComputeUnits,
                      cl_ulong* deviceGlobalMem, cl_ulong* deviceLocalMem, int* maxSubDevices);
    ...
    int getEventTimer(cl_event event, cl_ulong* queuedTime, cl_ulong* submitTime,
